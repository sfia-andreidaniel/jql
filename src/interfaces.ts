...
enum EJQL_LEXER_OPERATION_COMPARISION_TYPE {
    EQUALS = "==",
    LIKE   = "~=",
...
type EJQL_LEXER_OPERATOR_TYPE
    ...
    | EJQL_LEXER_OPERATION_COMPARISION_TYPE
...
interface IJQL_LEXER_EXPRESSION_LOGICAL extends IJQL_LEXER_EXPRESSSION_ABSTRACT {
    /** AND, OR **/
    operator: EJQL_LEXER_OPERATOR_LOGICAL_TYPE | EJQL_LEXER_OPERATION_COMPARISION_TYPE,
    left: IJQL_LEXER_EXPRESSION,
...
interface IJQL_LEXER_ORDER_BY_FIELDS_CLAUSE {
    // op = EJQL_LEXER_OPCODE_TYPES.ORDER_BY_OPTION
    type: EJQL_LEXER_ORDERING_STRATEGY;
...
interface IJQL_LEXER_UPDATE_FIELD {
